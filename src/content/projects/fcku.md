...
![On-device card detection: the camera view boxes each visible card and highlights the next one to confirm](/images/projects/fcku-camera.jpg)
...
![Odds calculator: recommendations and their edge over a 50/50 guess for each of the five rounds](/images/projects/fcku-calculator.jpeg)
...
![Statistics view: win probability per draw and cumulative win probability across 100,000 simulated games, compared across the optimal, smart, and blind strategies](/images/projects/fcku-statistics.jpeg)
